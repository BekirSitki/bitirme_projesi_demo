...
pygame.display.set_caption("Kawga")
...
# Fonts
menu_font = pygame.font.Font(resource_path("assets/fonts/MouldyCheese.ttf"), 50)
menu_font_title = pygame.font.Font(resource_path("assets/fonts/MouldyCheese.ttf"), 100)  # Larger font for title
count_font = pygame.font.Font(resource_path("assets/fonts/MouldyCheese.ttf"), 80)
score_font = pygame.font.Font(resource_path("assets/fonts/MouldyCheese.ttf"), 30)
